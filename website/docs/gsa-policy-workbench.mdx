...
[⭐ View on GitHub](https://github.com/microsoft/GSA-Policy-Workbench) [Getting started with the tool](https://github.com/microsoft/GSA-Policy-Workbench/blob/main/docs/getting-started.md)

## What is the GSA Policy Workbench Tool?

![GSA Policy Workbench Tool Overview page](./img/gsa-policy-bench-mainscreen-filemode01.png)
